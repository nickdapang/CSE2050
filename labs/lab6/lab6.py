class OrderedList:
    ...
    def __contains__(self, item):
        ...
        L = []
        return self._bs(L, item, 0, len(self) - 1) # You'll have to implement _bs() for this to work
    ...
    def _bs(self, L, item, left=0, right=None):
        ...
        return self._bs(L, item, left, right)